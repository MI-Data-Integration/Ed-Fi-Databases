...
namespace EdFi.Db.Deploy.Tests.Specifications
{
    ...
    [TestFixture]
    public class PostgresEngineSpecificationTests
    {
        public class When_parsing_command_options_with_valid_engine : TestFixtureBase
        {
            ...
            protected override void Arrange()
            {
                ...
                _sut = new PostgresEngineSpecification();
            }
            ...
            [Test]
            public void Should_return_true_if_postgres_is_selected() => _result.ShouldBeTrue();
        }
        ...
        public class When_parsing_command_options_with_invaild_engine : TestFixtureBase
        {
            ...
            [Test]
            public void Should_return_false_if_sqlserver_is_selected() => _result.ShouldBeFalse();
        }
    }
}
